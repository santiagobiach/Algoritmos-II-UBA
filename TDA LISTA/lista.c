...
void destruir_nodos_lista(lista_t* lista){
...
void borrar_nodo_en_final(lista_t* lista){
	nodo_t* nodo_auxiliar = lista->nodo_inicio;
...
void borrar_nodo_en_posicion(lista_t* lista, size_t posicion){
	nodo_t* nodo_auxiliar = lista->nodo_inicio;
...
int lista_borrar_de_posicion(lista_t* lista, size_t posicion){
	...
	if(posicion == 0){
		borrar_nodo_en_inicio(lista);
	}else{
		borrar_nodo_en_posicion(lista, posicion);
	}
